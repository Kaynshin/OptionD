...
Le handoff (`design_handoff_optiond/`) est la **source de vérité visuelle** : prototypes validés à transposer en code pixel-perfect. Voir `design_handoff_optiond/PROMPT.md` pour la mission détaillée.
